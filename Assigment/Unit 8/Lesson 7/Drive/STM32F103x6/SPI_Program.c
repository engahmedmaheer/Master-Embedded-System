...
SPI_Config_S Global_SPI_Config_S[SPI_DEFINE_NUM]={0};
...
uint8_t SPI_Init(const SPI_Config_S* SPIConfig)
{
	...
	Global_SPI_Config_S[SPIConfig->SPI_PERIPHERAL]=*(SPIConfig);

	Global_SPI_Config[SPIConfig->SPI_PERIPHERAL]=&Global_SPI_Config_S[SPIConfig->SPI_PERIPHERAL];
